...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **My Items**. A list of your submitted service requests and reported incidents is displayed:
     - To find a specific item, enter a keyword into the **Search My Items** field and use the drop-down list to focus the search. Then click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/bQ71XFd9ScR7BMH-VQ6Qx_search-icon14x12.png" alt caption} icon.
...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalogue**.
...
<ExpandableHeading>
  ...
  To find specific messages, enter text in the **Search Post** field (top right of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/IyZPvUMKdT1B0uqtO8to-_search-icon14x13.png" alt caption} icon.
...
<ExpandableHeading>
  ...
  To find specific content, enter text in the **Search for** field (top left of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/IyZPvUMKdT1B0uqtO8to-_search-icon14x13.png" alt caption} icon.
