...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/90eJtxYcCuANatBSnxGnK_catalog.png" position="flex-start" size="40" initialPath="i/catalog.png" githubPath="self-ENG/Content/Self-Service/i/catalog.png"></Image>

<hint type="info">
  Service Catalogue choices and forms depend on how your company configured \{\{FRS\_VARS.ProductName}}. See [Default Catalogue Offerings](<https://help.ivanti.com/ht/help/en_US/ISM/2026/admin-user/Content/ServiceDesk/ServiceCatalog/Default Catalog Offerings.htm>) to know the list of Service Catalogues available out-of-the-box.
</hint>

<ExpandableHeading>
  ## To submit a Service Request

  1. \{\{FRS\_VARS.Service\_Catalog-Service-Catalogue}}From the workspace menu, click .
