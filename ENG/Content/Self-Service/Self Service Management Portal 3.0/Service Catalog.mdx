...
The **Service Catalogue** workspace allows you to request, view, and manage \{\{FRS\_VARS.Request\_Offering-Request-Offering}} and Incidents. It lists all products and \{\{FRS\_VARS.Request\_Offering-Request-Offering}} available to you, such as requests for software, computers, or email, and groups them by category. You can track the progress of your requests through their lifecycle.

*Service Catalogue workspace*

<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/vexPQazlLqrccgtKvvhjr_service-catalog-v3.png" position="flex-start" size="40" initialPath="../i/service-catalog-v3.png" githubPath="self-ENG/Content/Self-Service/i/service-catalog-v3.png"></Image>

You can use the following features to view records within the workspace:

- **Filter by category or presets** : Filter \{\{FRS\_VARS.Request\_Offering-Request-Offering}} by department, Most popular, or Favourite (lists \{\{FRS\_VARS.Request\_Offering-Request-Offering}} marked as favorites) or preset to define the category such as (HR Services, Most Popular Request Offerings, New Incidents, IT Services, Facility Services).
- **Group by category** : Organise \{\{FRS\_VARS.Request\_Offering-Request-Offering}} by their category to streamline your search such as ascending or descending order.
- **Save as draft** : Save \{\{FRS\_VARS.Request\_Offering-Request-Offering}} as drafts to complete and submit later. Unsent requests appear as drafts at the top-right of the page.
- **Search by keyword** : Use the Search bar to find \{\{FRS\_VARS.Request\_Offering-Request-Offering}} using specific keywords.
...
<ExpandableHeading>
  ...
  2. On the **Service Catalogue**, in search bar, type generic request.
...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalogue**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/WommUaBJPRsD4DcbYUOL4_service-catalog-icon-ssm-3017x17.png" alt caption} icon .
  ...
  7. You can search for offering using the **Search Services** field. You cannot edit an incident once it is logged, but you can update it with notes or attachments (such as images or documents). You can also close an incident, regardless of its status. For details, see [My Items](../my-items.mdx).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{FRS\_VARS.ProductName}}.
  2. From the workspace menu, select **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/WommUaBJPRsD4DcbYUOL4_service-catalog-icon-ssm-3017x17.png" alt caption}icon .
  ...
  <Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/V27flysWGTcdPXe5m275W_service-request-incident-example.png" position="flex-start" size="100" indent="1" initialPath="../i/service-request-incident-example.png" githubPath="self-ENG/Content/Self-Service/i/service-request-incident-example.png"></Image>
  ...
  7. If you need to update an in-progress offering request, you can add notes or attachments, such as images or documents. For more details, see [My Items](<My Items.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{FRS\_VARS.ProductName}}.
  2. From the **Service Catalogue** workspace, select a record and click either the Copy or share link:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/m5gZbCX9vlUsJI-7ZvWrq_icon-ssm-3024x24.png" alt caption}icon.
     - **To copy the link**: Select **Copy Link**. A message will confirm that the link has been copied to your clipboard.
     - **To send an email**: Select **Email** :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/aGp02pT4LIewozyZhgVpz_send-email-ssm-3018x18.png" alt caption} icon. The default email client opens with the offering record in the email body. Enter the recipient details and send the email.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  <Paragraph listStyleType="disc" indent="2">
    To add a offering to your Favorites, in the Service Catalogue workspace, click the **Favorites** icon.
  </Paragraph>
