...
<ExpandableHeading>
  ...
  6. To minimise the conversation, click the conversation header. Click the header again to toggle open.
  7. To remove conversations, click the **Remove Conversation from the Chat Zone&#x20;**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/1cTzx-cGK8yU5KpNjsCzd_chat-remove-icon17x14.png" alt caption} icon.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  6. Click the chat :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/6wf09UFMD_O4Amo6MCu0V_chat-icon17x15.png" alt caption} icon in the message window to move the conversation into the Chat Zone. You can continue chatting with the group from the Chat Zone.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Within the conversation header, click the pop-out arrow :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/8cjL9hbGAfVxFbVs2dEQ3_chat-arrow-icon15x15.png" alt caption} icon.
