...
<ExpandableHeading>
  ...
  7. To remove conversations, click the **Remove Conversation from the Chat Zone&#x20;**:inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/YipN2afRjf5Pza_YOGgHq_chat-remove-icon17x14.png" alt caption} icon.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  6. Click the chat :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/d5urgHIRvu6F8XRrAmaIY_chat-icon17x15.png" alt caption} icon in the message window to move the conversation into the Chat Zone. You can continue chatting with the group from the Chat Zone.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Within the conversation header, click the pop-out arrow :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/1sBM3RPjGPjKLCIdgtRMn_chat-arrow-icon15x15.png" alt caption} icon.
