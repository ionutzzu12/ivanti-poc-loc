...
slug: reporting-incidents-and-submitting-requests
docTags: 
...
On some devices, the Service Catalog is viewable as a list or in tiles. Toggle the view by tapping the list view icon :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/jQb-KJETF1SBfK_UKovNT_list-icon16x12.png" alt caption} or the tile view :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/FvtHiU-uZIrJj40zl4nwr_tile-icon16x11.png" alt caption} icon in the upper-right area of the page. Note that the tile view displays items in large tiles, which take up more space and list fewer items on the screen.
...
- To add a service to the Favorites, from the Service Catalog workspace, tap the Favorites icon :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/SWKkLZhu_2zPbUD_aLNM0_favorites-disabled.png" alt caption}. The Favorites icon changes to :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/L1PB3WohKkXCbb0YKP2EL_favorites-selected.png" alt caption}, you will get a pop-up message that the selected service is added to Favorites and the service is moved to the top of the list along with other services that are already added to Favorites.
...
<ExpandableHeading>
  ...
  1. Tap the Service Catalog :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/8cGvrUSAIZ0aPY0NvYO2J_servicecatalogicon.png" alt caption} icon.
...
<ExpandableHeading>
  ...
  1. Tap the :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/3TRQNoAwnEiayMMimX_q2_myitemsicon.png" alt caption} icon to open **My Items**. A list of your open items appears.
