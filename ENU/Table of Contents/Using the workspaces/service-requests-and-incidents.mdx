...
slug: service-requests-and-incidents
docTags: 
...
If you need to update an in-progress service request with a note or an attachment such as an image or a document, you can do so. For details, see [My Items](my-items.htm).
...
You can't edit an incident once it's logged, but you can update it with a note or attachment (such as an image, document, and so on). You can also close an incident, regardless of its current status. For details, see [My Items](my-items.htm).
