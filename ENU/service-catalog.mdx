...
The **Service Catalog** workspace allows you to request, view, and manage \{\{FRS\_VARS\_Self.Request\_Offering}} and Incidents. It lists all products and \{\{FRS\_VARS\_Self.Request\_Offering}} available to you, such as requests for software, computers, or email, and groups them by category. You can track the progress of your requests through their lifecycle.

*Service Catalog workspace*

<Image src="../../Resources/images/service-catalog-v3.png" position="flex-start" size="40" initialPath="../../Resources/images/service-catalog-v3.png" githubPath="self/Content/Resources/images/service-catalog-v3.png"></Image>
...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalog**:inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/dMADHks4R12mRvADmFwM2_service-catalog-icon-ssm-3017x17.png" alt caption} icon .
  ...
  7. You can search for offering using the **Search Services** field. You cannot edit an incident once it is logged, but you can update it with notes or attachments (such as images or documents). You can also close an incident, regardless of its status. For details, see [My Items](<Table of Contents/Using the workspaces/my-items.mdx>).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product-Neurons-for-ITSM.}}.
  2. From the workspace menu, select **Service Catalog**:inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/dMADHks4R12mRvADmFwM2_service-catalog-icon-ssm-3017x17.png" alt caption}icon .
  ...
  <Image src="../../Resources/images/service-request-incident-example.png" position="flex-start" size="40" indent="1" initialPath="../../Resources/images/service-request-incident-example.png" githubPath="self/Content/Resources/images/service-request-incident-example.png"></Image>
  ...
  7. If you need to update an in-progress offering request, you can add notes or attachments, such as images or documents. For more details, see [My Items](NIzC-my-items.mdx).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to \{\{Primary.Product-Neurons-for-ITSM.}}.
  2. From the **Service Catalog** workspace, select a record and click either the Copy or share link:inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/5Mp_LypFX5-AlCQcCc4_N_icon-ssm-3024x24.png" alt caption}icon.

  - **To copy the link**: Select **Copy Link**. A message will confirm that the link has been copied to your clipboard.
  - **To send an email**: Select **Email** :inlineImage[]{src="https://api.archbee.com/api/optimize/fNEeV2bO-J-V0NK1eH_VR/iZLRrfS_o34UCAEgGFXNQ_send-email-ssm-3018x18.png" alt caption} icon. The default email client opens with the offering record in the email body. Enter the recipient details and send the email.
</ExpandableHeading>
