...
En algunos dispositivos, el Catálogo de servicios se puede ver como una lista o en mosaico. Alterne la vista pulsando icono de vista de lista :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/xxGf38F6wtKMAAmjXAIjP_list-icon16x12.png" alt caption} o el icono de vista de mosaico :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/U0fkUST1PR-3CuxDb7L0Q_tile-icon16x11.png" alt caption} en la parte superior derecha de la página. Tenga en cuenta que la vista de mosaico muestra elementos en mosaicos grandes, que ocupan la mayor parte del espacio y se listan menos elementos en la pantalla.
...
- Para agregar un servicio a Favoritos, desde el espacio de trabajo Catálogo de servicio, pulse el icono de Favoritos :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/GVGEuFIFmMO5sjAQShSap_favorites-disabled.png" alt caption}. El icono de Favoritos cambia a :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/_GoC04vXqsHRj1Z0OctdY_favorites-selected.png" alt caption}, aparecerá un mensaje que indica que el servicio seleccionado se ha agregado a Favoritos y el servicio se traslada a la parte superior de la lista junto a los otros servicios Favoritos.
...
<ExpandableHeading>
  ...
  1. Pulse el icono del Catálogo de servicios :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/x2dk_po8hFg2-CV1HhWt3_servicecatalogicon.png" alt caption}.
...
<ExpandableHeading>
  ...
  1. Pulse el icono :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/u39Pm7AuH0eRcmWhbTHWc_myitemsicon.png" alt caption} para abrir **Mis elementos**. Se muestra una lista de elementos abiertos.
