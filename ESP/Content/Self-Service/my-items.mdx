...
<ExpandableHeading>
  ...
  ![](https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/9pz5EbyBYMJWhL09WkVe8_my-items.png)
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  - Para buscar un elemento específico, introduzca una palabra clave en el campo **Buscar Mis elementos** y haga clic en el icono :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/zFVIwVLx27XOy1yo_95CZ_search-icon14x13.png" alt caption}. Se mostrarán los resultados que coincidan.
  - Para centrar la búsqueda, utilice el desplegable de búsqueda para seleccionar una categoría de Solicitud, Problema, etc.
  - Para borrar todos los criterios de búsqueda, haga clic en el icono :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/FqjJaxugfKwEsXRmQ0uew_red-x-icon14x13.png" alt caption}.
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  <Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/sCPpbrXSI2PHiGrGNj8ql_catalog.png" position="flex-start" size="100" indent="1" initialPath="i/catalog.png" githubPath="self-ESP/Content/Self-Service/i/catalog.png"></Image>
...
<ExpandableHeading>
  ...
  3. Haga clic en la pestaña **Progreso de la solicitud de servicio**.
     ...
     - En el campo **Agregar archivo adjunto**, haga clic en el icono :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/sNiIDjtUG9ARbKtJn-KFG_browse-icon18x15.png" alt caption} para seleccionar un archivo que desee adjuntar.
