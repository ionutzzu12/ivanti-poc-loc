...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **My Items**. A list of your submitted service requests and reported incidents is displayed:
     - To find a specific item, enter a keyword into the **Search My Items** field and use the drop-down list to focus the search. Then click the :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/0NcyQe7S6evPGjwNuOO5N_search-icon14x12.png" alt caption} icon.
  ...
  For more information, see [My Items](docId:1M9bvU9DObUz4IwkzaFeT).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Service Requests and Incidents](docId\:RizLpcFVTQGxLPnbAWW4L).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific messages, enter text in the **Search Post** field (top right of page) and click the :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/VLecp3AsrsdKyiafDgfln_search-icon14x13.png" alt caption} icon.

  To filter the real-time stream of messages in the main pane, use the filter criteria in the left Activity Stream pane.

  For more information, see [Social Board messages](docId\:ipmIwmE70HQxAacNfp1fH).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific content, enter text in the **Search for** field (top left of page) and click the :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/VLecp3AsrsdKyiafDgfln_search-icon14x13.png" alt caption} icon.
  ...
  For more information, see [Announcements, FAQs, and Alerts](docId\:EQPicyVdAUHYlxJvSkhBW).
</ExpandableHeading>
