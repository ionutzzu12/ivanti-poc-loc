...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **My Items**. A list of your submitted service requests and reported incidents is displayed:
     - To find a specific item, enter a keyword into the **Search My Items** field and use the drop-down list to focus the search. Then click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/3wF75E28skRCu9vbAH6eo_search-icon14x12.png" alt caption} icon.
  ...
  For more information, see [My Items](docId\:ZEoQ8ngleP8L3cOEYIX77).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  For more information, see [Service Requests and Incidents](docId\:h_UgtTskCOmNh9Wu0livJ).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific messages, enter text in the **Search Post** field (top right of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/8Ueo8LeQ_6l9y10IInRE9_search-icon14x13.png" alt caption} icon.

  To filter the real-time stream of messages in the main pane, use the filter criteria in the left Activity Stream pane.

  For more information, see [Social Board messages](docId:_LLCgqJsHHur_Z4AbagU_).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  To find specific content, enter text in the **Search for** field (top left of page) and click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/8Ueo8LeQ_6l9y10IInRE9_search-icon14x13.png" alt caption} icon.
  ...
  For more information, see [Announcements, FAQs, and Alerts](docId\:LWn5nQWQ-9gGDk1zKyp2R).
</ExpandableHeading>
