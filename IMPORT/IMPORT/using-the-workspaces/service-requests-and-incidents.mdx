...
<Image src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/AmYYjrp5O4OnzH9kf-TdL_catalog.png" position="flex-start" size="40" initialPath="../Resources/images/catalog.png" githubPath="self/Content/Resources/images/catalog.png" width="1832" height="758" darkWidth="1832" darkHeight="758"></Image>

<hint type="info">
  Service Catalog choices and forms depend on how your company configured \{\{Primary.Product-Neurons-for-ITSM}}. See [Default Catalog Offerings]() to know the list of Service Catalogs available out-of-the-box.
</hint>
...
If you need to update an in-progress service request with a note or an attachment such as an image or a document, you can do so. For details, see [My Items](docId:1M9bvU9DObUz4IwkzaFeT).
...
You can't edit an incident once it's logged, but you can update it with a note or attachment (such as an image, document, and so on). You can also close an incident, regardless of its current status. For details, see [My Items](docId:1M9bvU9DObUz4IwkzaFeT).
