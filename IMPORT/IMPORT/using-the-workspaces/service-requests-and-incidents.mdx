...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/sZUqVacCwDB6twDBE2KG2_catalog.png" position="flex-start" size="40" initialPath="../Resources/images/catalog.png" githubPath="self/Content/Resources/images/catalog.png"></Image>

<hint type="info">
  Service Catalog choices and forms depend on how your company configured Neurons for ITSM. See [Default Catalog Offerings](<https://help.ivanti.com/ht/help/en_US/ISM/2026/admin-user/Content/ServiceDesk/ServiceCatalog/Default Catalog Offerings.htm>) to know the list of Service Catalogs available out-of-the-box.
</hint>
...
If you need to update an in-progress service request with a note or an attachment such as an image or a document, you can do so. For details, see [My Items](docId\:ZEoQ8ngleP8L3cOEYIX77).
...
You can't edit an incident once it's logged, but you can update it with a note or attachment (such as an image, document, and so on). You can also close an incident, regardless of its current status. For details, see [My Items](docId\:ZEoQ8ngleP8L3cOEYIX77).
