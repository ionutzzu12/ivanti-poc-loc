...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/Qk2tdXnpBwjRANa0SlosU_service-catalog-v3.png" position="flex-start" size="40" initialPath="../../Resources/images/service-catalog-v3.png" githubPath="self/Content/Resources/images/service-catalog-v3.png"></Image>
...
<ExpandableHeading>
  ...
  1. From the workspace menu, click **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/LHuoo8DWXQ0xb_sx-GoH-_service-catalog-icon-ssm-3017x17.png" alt caption} icon .
  ...
  7. You can search for offering using the **Search Services** field. You cannot edit an incident once it is logged, but you can update it with notes or attachments (such as images or documents). You can also close an incident, regardless of its status. For details, see [My Items](docId\:ZEoQ8ngleP8L3cOEYIX77).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to Neurons for ITSM.
  2. From the workspace menu, select **Service Catalog**:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/LHuoo8DWXQ0xb_sx-GoH-_service-catalog-icon-ssm-3017x17.png" alt caption}icon .
  ...
  <Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/6fS-4ehJtuszaEU-BlEuh_service-request-incident-example.png" position="flex-start" size="40" indent="1" initialPath="../../Resources/images/service-request-incident-example.png" githubPath="self/Content/Resources/images/service-request-incident-example.png"></Image>
  ...
  7. If you need to update an in-progress offering request, you can add notes or attachments, such as images or documents. For more details, see [My Items](docId\:Gkzvx5dLwTw46Z5JjqwRn).
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  1. Log in to Neurons for ITSM.
  2. From the **Service Catalog** workspace, select a record and click either the Copy or share link:inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/sSQUKV921O3DnWBmrfb5Z_icon-ssm-3024x24.png" alt caption}icon.
     - **To copy the link**: Select **Copy Link**. A message will confirm that the link has been copied to your clipboard.
     - **To send an email**: Select **Email** :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/t0_ur0qZbk2uzgadtbwWR_send-email-ssm-3018x18.png" alt caption} icon. The default email client opens with the offering record in the email body. Enter the recipient details and send the email.
</ExpandableHeading>
