...
On some devices, the Service Catalog is viewable as a list or in tiles. Toggle the view by tapping the list view icon :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/RHwxmfKWURRgwZZPnpG1M_list-icon16x12.png" alt caption} or the tile view :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/3MKDoqFxc8D47tVMK5YQK_tile-icon16x11.png" alt caption} icon in the upper-right area of the page. Note that the tile view displays items in large tiles, which take up more space and list fewer items on the screen.
...
- To add a service to the Favorites, from the Service Catalog workspace, tap the Favorites icon :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/ZwhASEJ30_QVJmKCnQ3Wr_favorites-disabled.png" alt caption}. The Favorites icon changes to :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/zGLyXucCOlkuTUTEaUYFG_favorites-selected.png" alt caption}, you will get a pop-up message that the selected service is added to Favorites and the service is moved to the top of the list along with other services that are already added to Favorites.
...
<ExpandableHeading>
  ...
  1. Tap the Service Catalog :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/TfGwIhZ344bM6rGVFvJsf_servicecatalogicon.png" alt caption} icon.
...
<ExpandableHeading>
  ...
  1. Tap the :inlineImage[]{src="https://archbee-image-uploads.s3.amazonaws.com/parib0MC3hVoUNdfQdnac/kKvuLP0M8hAl1MFRdN8z5_myitemsicon.png" alt caption} icon to open **My Items**. A list of your open items appears.
