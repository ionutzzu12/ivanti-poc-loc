...
On some devices, the Service Catalog is viewable as a list or in tiles. Toggle the view by tapping the list view icon :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/V8ar8-xiRUqoNRH6dBcNb_list-icon16x12.png" alt caption} or the tile view :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/I9fhCiLXFOdOoAYGl7YQD_tile-icon16x11.png" alt caption} icon in the upper-right area of the page. Note that the tile view displays items in large tiles, which take up more space and list fewer items on the screen.
...
- To add a service to the Favorites, from the Service Catalog workspace, tap the Favorites icon :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/dGEvvMbKSGY536QYU4fsY_favorites-disabled.png" alt caption}. The Favorites icon changes to :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/Fot3vcdvfZFQ2vu9BEAf__favorites-selected.png" alt caption}, you will get a pop-up message that the selected service is added to Favorites and the service is moved to the top of the list along with other services that are already added to Favorites.
...
<ExpandableHeading>
  ...
  1. Tap the Service Catalog :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/aSWV18JKo3mDHqS8W5mAi_servicecatalogicon.png" alt caption} icon.
...
<ExpandableHeading>
  ...
  1. Tap the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/LO8gWBZkxeBBszausth-p_myitemsicon.png" alt caption} icon to open **My Items**. A list of your open items appears.
