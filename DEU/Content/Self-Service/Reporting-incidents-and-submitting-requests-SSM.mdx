...
Auf einigen Geräten kann der Servicekatalog als Liste oder als Kacheln angezeigt werden. Schalten Sie die Ansicht um, indem Sie oben rechts auf der Seite auf das Symbol für die Listenansicht :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/Q4mNQhT5BFPNcoD00B7ml_list-icon16x12.png" alt caption} oder auf das Symbol für die Kachelansicht :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/17dF8596-IRuztWnEYk9s_tile-icon16x11.png" alt caption} tippen. Bei der Kachelansicht werden die Elemente in großen Kacheln angezeigt. Dies nimmt mehr Platz in Anspruch, sodass weniger Elemente auf dem Bildschirm sichtbar sind.
...
- Um einen Service zu den Favoriten hinzuzufügen, tippen Sie im Workspace "Servicekatalog" auf das Favoritensymbol :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/2x898xbL4Yhy4P3ay3jQq_favorites-disabled.png" alt caption}. Das Favoritensymbol wechselt in :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/0eFVtg7dWXEF9xhsEEdd-_favorites-selected.png" alt caption}, Sie erhalten eine Popup-Meldung, die den Vorgang bestätigt und der Service wird oben auf die Liste gesetzt, wo sich bereits andere Services befinden, die ebenfalls als Favorit hinzugefügt wurden.
...
<ExpandableHeading>
  ...
  1. Tippen Sie auf das Symbol für den Servicekatalog :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/nMQBkfrZzaGmjrO53ZoYy_servicecatalogicon.png" alt caption}.
...
<ExpandableHeading>
  ...
  1. Tippen Sie auf das Symbol :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/vKXfqC7M_47jpquopH2j-_myitemsicon.png" alt caption}, um **Meine Elemente** zu öffnen. Eine Liste Ihrer offenen Elemente wird angezeigt.
