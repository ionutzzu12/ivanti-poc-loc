...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/gqhbuI08hHtQW1V0HE1w0_ss-homepage.png" position="flex-start" size="40" initialPath="i/SS-HomePage.png" githubPath="self-DEU/Content/Self-Service/i/SS-HomePage.png"></Image>
...
**7. Vollbildmodus-Schaltfläche** - Klicken Sie auf dieses Symbol, um die Anwendung im Vollbildmodus darzustellen. Um zur normalen Ansicht zurückzukehren, klicken Sie auf das Symbol für **Vollbildmodus beenden**: :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/HAwwfedV05VbY9YZs5qm3_exitfullscreenicon.png" alt caption}
