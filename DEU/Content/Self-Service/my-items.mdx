...
<ExpandableHeading>
  ...
  ![](https://api.qa.archbee.co/api/optimize/HEkQtFhyYgE4ZSdJlwxXe/2GFp2C70NC2guy2FKxbI7-20260824-063908.png)
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  <Image src="https://api.qa.archbee.co/api/optimize/HEkQtFhyYgE4ZSdJlwxXe/fxiqG0yalecWIZx3Ll3po-20260824-063908.png" position="flex-start" size="100" indent="1" initialPath="i/catalog.png" githubPath="self-DEU/Content/Self-Service/i/catalog.png" showCaption="false"></Image>
...
<ExpandableHeading>
  ...
  3. Klicken Sie auf die Registerkarte **Service Request: Aktueller Stand**.
     ...
     - Klicken Sie im Feld **Anhang hinzufügen** auf das Symbol :inlineImage[]{src="https://api.qa.archbee.co/api/optimize/yzXkkCTORWlcwRG_AVHKZ/G3yqIaaeQ4r4XgEP3h9ZT_browse-icon18x15.png" alt caption}, um eine Datei auszuwählen, die angehängt werden soll.
