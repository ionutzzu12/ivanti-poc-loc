...
<ExpandableHeading>
  ...
  ![](https://api.qa.archbee.co/api/optimize/yzXkkCTORWlcwRG_AVHKZ/2nuFsGhSLa_oPWL3QJgvR_my-items.png)
</ExpandableHeading>
...
<ExpandableHeading>
  ...
  <Image src="https://api.qa.archbee.co/api/optimize/yzXkkCTORWlcwRG_AVHKZ/tzD3Mvx_GbZYLXpHlf3qX_catalog.png" position="flex-start" size="100" indent="1" initialPath="i/catalog.png" githubPath="self-DEU/Content/Self-Service/i/catalog.png" showCaption="false"></Image>
