...
Su alcuni dispositivi, il Catalogo dei servizi è visualizzabile come un elenco o come riquadri. Attivare/disattivare la vista toccando l'icona della visualizzazione elenco :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/cJwuk2bkn3QD3RQ7VmhP4_list-icon16x12.png" alt caption} o l'icona :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/0SoustgmFcSpvsIu2zj2D_tile-icon16x11.png" alt caption} visualizzazione riquadri nell'area in alto a destra della pagina. Notare che la visualizzazione riquadri mostra gli elementi mediante riquadri grandi, che occupano più spazio ed elencano meno elementi a schermo.
...
- Per aggiungere un servizio ai Preferiti, dall'area di lavoro Catalogo dei servizi toccare l'icona Preferiti :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/NPDhO9pNhdBs7H4q-_ygp_favorites-disabled.png" alt caption}. L'icona Preferiti passa a :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/0o7NN-Ko5IZv5VcT6mAKB_favorites-selected.png" alt caption}, si otterrà un messaggio di pop-up relativo al fatto che il servizio selezionato è stato aggiunto ai Preferiti e il servizio viene spostato in cima all'elenco insieme ad altri servizi già aggiunti ai Preferiti.
...
<ExpandableHeading>
  ...
  1. Toccare l'icona :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/I5v-BVTWVUVp3HvAbPntr_servicecatalogicon.png" alt caption} del Catalogo dei servizi.
...
<ExpandableHeading>
  ...
  1. Toccare l'icona :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/4zkuapbTByJ6gm4xuguHy_myitemsicon.png" alt caption} per aprire **Elementi personali**. Apparirà un elenco dei propri elementi aperti.
